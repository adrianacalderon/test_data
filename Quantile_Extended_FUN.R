#' Extended Quantile function to include Cunnane methodology
#' Function is provided at https://github.com/eurostat/quantile
...
quantile_extended <- function(x, data = NULL, probs=seq(0, 1, 0.25), na.rm=FALSE, type=7, method="DIRECT", names= FALSE) {
  if (!type %in% 1:11) 
